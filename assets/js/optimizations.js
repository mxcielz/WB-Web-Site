    ...
    setupAccessibility() {
        ...
        document.querySelectorAll('button:not([aria-label])').forEach(button => {
            if (!button.textContent.trim()) {
                button.setAttribute('aria-label', 'Botè´™o');
            }
        });
...
// Create and download the site.webmanifest
const manifestData = {
    name: "WB Manutenè´Æè´™o",
    short_name: "WB Manutenè´Æè´™o",
    start_url: "/",
    display: "standalone",
...
// Call the function to create the manifest file
createManifestFile();
